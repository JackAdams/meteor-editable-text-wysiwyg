Package.describe({
  ...
  summary: 'Don\'t add this package - it is added automatically when adding a wysiwyg editor to babrahams:editable-text',
  version: '0.5.4',
...
Package.onUse(function(api) {
  ...
  api.use('babrahams:editable-text@0.8.4', 'client');
